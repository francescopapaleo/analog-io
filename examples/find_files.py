...
AUDIO_EXTENSIONS = ['.wav', '.aiff',]  # Example extensions

def find_audio_files(start_path: str, extensions: List[str] = AUDIO_EXTENSIONS) -> List[str]:
...
def filter_audio_files_by_properties(audio_files: List[str], sample_rate: int, subtype: str) -> List[str]:
...
if __name__ == "__main__":
    ...
    filtered_files = filter_audio_files_by_properties(audio_files, target_sample_rate, target_bit_depth)
